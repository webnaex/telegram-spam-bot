...
class SpamDetector:
    ...
    def detect_spam(
        ...
        keyword_threshold = config.NEW_USER_KEYWORD_THRESHOLD if is_new_user else config.SPAM_KEYWORD_THRESHOLD
