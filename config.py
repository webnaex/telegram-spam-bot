...
SPAM_KEYWORDS: List[str] = [
    ...
    'altcoin', 'altcoins', 'coin', 'token', 'krypto', 'btc', 'eth',
    'schlussverkauf', 'sale', 'verkauf', 'sell', 'trading', 'trade',
    
    # Gambling/Casino
    'casino', 'bet', 'jackpot', 'slot', 'poker', 'gambling', 'jetluxe', 'vexway',
    'payout', 'withdraw', 'withdrew', 'withdrawal', 'deposit', 'play now', 'player',
    'promo code', 'promo', 'promocode', 'code', 'registration', 'no deposit', 'nodeposit',
    'roulette', 'blackjack', 'sports betting', 'sweet bonanza',
    'broke', 'proof', 'hesitate', 'cashing out', 'cash out', '50cent',
    ...
    # Recovery Scams (NEU!)
    'opfer', 'victim', 'anlagebetrug', 'investment fraud', 'wiederherstellung',
    'recovery', 'cryptorecovery', 'gebühren', 'fees', 'wallet', 'passkey',
    'zurückbekommen', 'get back', 'recover', 'schnelles handeln', 'quick action',
...
SUSPICIOUS_DOMAINS: List[str] = [
    ...
    'centlom.com', 'centlom.space', 'centlom.site', 'centlom.online',
...
NEW_USER_WINDOW = 604800  # 7 Tage - User gilt als "neu" wenn vor weniger als 7 Tagen beigetreten
